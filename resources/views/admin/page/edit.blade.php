...
<div class="row">
    <div class="col-md-12">
        <h1 class="page-head-line">Pages Edit</h1>
        <span class="page-subhead-line"><strong><a href="{{route('dashboard')}}">Dashboard</a> >> 
            <a href="{{route('page.index')}}">page List</a>>> Edit Page </span>
